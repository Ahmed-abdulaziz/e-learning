...
$user=$stmt->fetch();
  ...
  $msg=" Dear ".$user['name'].",<br><br> <a href='https://ezystudies.com/student/reset-password.php?code=$code'>Click here to change password</a>";
    $ch = curl_init();
    $url= "https://smssmartegypt.com/sms/api/?username=easyphysics&password=75E824*tR&sendername=EzyStudies&mobiles=2".$user['phone']."&message=".urlencode($msg);
    ...
    if (!$url) {
        echo "Mailer Error: " . $mail->ErrorInfo;
            ...
            header("Location:index.php?forget-pass=".urlencode("Check Your phone"));
            exit();
    }
                                        ...
                                        <?php }?>
                                            ...
                                            <div class="row">
                                                <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                                    ...
                                                    <input type="text" placeholder="please enter your phone" class="form-control" name="phone" value="<?php if(!empty($err2)) { echo $phone; } ?>" required>
                                                </div>
