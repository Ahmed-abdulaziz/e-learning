                 ...
                 <div class="breadcrumbs-area">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <ul>
                                <li>
                                    <a href="exmodelanswer.php">ExamModelAnswer</a>
                                </li>
                                <li>Student</li>
                            </ul>
                        </div>
                        ...
                        <?php   
                            ...
                            if($type=='0') { 
                                ...
                                <span class="checkmark <?php if($currentquestion['answer']==1){ echo "true";} elseif($answer==1){ echo "wrong";}?> "></span>
                                        ...
                                        <?php if($currentquestion['choice1img'] != NULL){?>
                                        <img src="../dashboard/img/questions/<?php echo $currentquestion['choice1img']; ?>">
                                        <?php }?>
                                ...
                                <input type="radio" disabled value="<?php echo "2"; ?>" <?php if($answer==2 || $currentquestion['answer'] == 2) echo "checked";?>>
                                ...
                                <input type="radio" disabled  value="<?php echo "3";?>" <?php if($answer==3 || $currentquestion['answer'] == 3) echo "checked";?>>
                                ...
                                <input type="radio" disabled  value="<?php echo "4";?>" <?php if($answer==4 || $currentquestion['answer'] == 4) echo "checked";?> >
