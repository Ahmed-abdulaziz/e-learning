...
$stmt=$con->prepare("SELECT * FROM subjects WHERE id IN  (SELECT subjectid FROM weeks WHERE id IN (SELECT product_id FROM student_wallet WHERE studentid = ? AND type = ?))");
$stmt->execute(array($stdid,"Week"));
                ...
                <div class="row">
                    ...
                    <div class="col-12-xxxl col-12">
                        <div class="row">
                            ...
                            ?>
                            <div class="col-lg-3">
                                <a href="mychapters.php?do=session&sid=<?php echo $subject['id']; ?>">
