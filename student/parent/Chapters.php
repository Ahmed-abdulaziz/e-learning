...
$stmt=$con->prepare("SELECT DISTINCT chapter FROM weeks WHERE subjectid = ?  AND chapter IS NOT NULL  ");
                ...
                <div class="row">
                    ...
                    <div class="col-12-xxxl col-12">
                        ...
                        <div class="row">
                            ...
                            ?>
                            <div class="col-lg-4">
                                <a href="weeks.php?cid=<?php echo $week['chapter'] ?>" class="w-100">
                                <div class="dashboard-summery-one">
                                        ...
                                        <div class="item-content text-center py-3">
                                            <h4 class="item-title text-dark font-weight-bold"><?php echo $chapter['name'];?> - (<?php echo $noWeeks['total']; ?> Week)</h4>
                                        </div>
