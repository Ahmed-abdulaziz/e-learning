...
$stmt=$con->prepare("SELECT * FROM videos WHERE subjectid=? AND type=? AND free = ?");
$stmt->execute(array($_SESSION['subject'],"online+offline",0));
                            ...
                            <div class="card-header" id="headingOne">
                              <h5 class="mb-0">
                                <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style="color: black; font-size: 24px; width: 100%; text-align: left;">
                                   Videos<span style="float: right;">&#8595;</span>
                                </button>
                          ...
                          <div class="card">
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                              <div class="card-body">
                                ...
                                <div class="col-lg-4">
                                    <a href="<?php echo $url;?>?id=<?php echo $video['id']; ?>">
