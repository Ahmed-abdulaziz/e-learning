                ...
                <div class="breadcrumbs-area">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <ul>
                                <li>
                                    <a href="homeworks-current.php">Homeworks-current</a>
                                </li>
                                <li>Student</li>
                            </ul>
                        </div>
                            ...
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <?php if(!empty($homeworks)){ foreach ($homeworks as $homework){ 
                                            
                                            $homeworkid=$homework['id'];
                                            $stmt=$con->prepare("SELECT * FROM studenthw WHERE homeworkid = ? AND studentid = ?");
                                        ...
                                        <td><a href="answers.php?id=<?php echo $homework['id'];?>&&page=1">Start solving</a></td>
