...
if(empty($err)){
    ...
    $stmt=$con->prepare("UPDATE  gallery SET link=? , image=?  WHERE id=?");
    $stmt->execute(array($link,$Mimage,$id));
    header("Location:gallery.php?mssg=".urlencode("Done Editing Photo"));
}
}
...
<head>
    ...
    <title>E-Learning System | Edit Photo</title>
                                ...
                                <form class="new-added-form" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <label>Link</label>
                                            <input type="text" placeholder="New Link" class="form-control" name="link" value="<?php echo $inputs['link']; ?>">
                                           
                                        </div>
                                          <div class="col-xl-3 col-lg-6 col-12 form-group">
                                              
                                            <label>Image</label>
                                            <input type="file" placeholder="New Image" class="form-control" name="image" >
                                           
                                        </div>

                                            <input type="text" hidden placeholder="Image" class="form-control" name="oldimage" value="<?php echo $inputs['image']; ?>">
