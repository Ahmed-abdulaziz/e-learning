...
if($type!="super admin" && $type!="admin" && $type!="teacher"){
...
if(empty($errr)){
     $stmt=$con->prepare("INSERT INTO admins (name,password,type,t_id)
         VALUES(:name,:password,'assistant  ',:tid)");
     $stmt->execute(array('name'=>$namee ,'password'=>$password,'tid'=>$tid));
     header("Location:ass.php?msgg=".urlencode("Done Adding Assistant"));
      exit();
}
...
<head>
    ...
    <title>E-Learning System | Add Assistant</title>
                                    ...
                                    <div class="row">
                                       ...
                                       <?php if($type=="admin"){ 
                                        ...
                                        <div class="col-3-xxxl col-lg-6 col-12 form-group">
                                            <label>Teacher</label>
                                            <select class="select2" name="tid" required>
