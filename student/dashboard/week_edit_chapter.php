...
if(empty($err4)){
    $stmt=$con->prepare("UPDATE  week_chapters SET name=? WHERE id=?");     
    $stmt->execute(array($name,$id));
    header("Location:week_chapter.php?mssg=".urlencode("Done Editing chapter"));
    exit();
}

}} else {
    error_log("CSRF Failed from file week_edit_chapter.php", 0);
}
}
...
<head>
    ...
    <title>E-Learning System  | Edit Week chapter</title>
          ...
          <?php include_once 'sidebar.php' ?>
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3> Edit Week chapter</h3>
                    <ul>
                        <li>
                            <a href="teachers.php">chapters</a>
                        </li>
                        <li>Edit Week chapter</li>
                    </ul>
                </div>
