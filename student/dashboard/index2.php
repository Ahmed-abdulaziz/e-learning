...
$do = $_GET['do'];
 ...
 if($do == 'delete'){
    if($_GET['id']){
      ...
      $stmt->execute();
      header("Location:index2.php?msg=".urlencode("Done Deleteing Admin"));
      exit();
  }}}
...
<head>
    ...
    <title>E-Learning System | Admins</title>
                                ...
                                <tbody>
                                    <tr>
                                      <?php if(isset($_SESSION['adminname'])){ foreach($admins as $admin){ ?>
                                        ...
                                        <td>
                                            <a class="fw-btn-fill btn-gradient-yellow" href="account-settings.php?do=edit&id=<?php echo $admin["id"] ?>">Edit </a>
                                            <a class="fw-btn-fill btn-gradient-yellow" href="index2.php?do=delete&id=<?php echo $admin["id"] ?>">Delete</a>
                                        </td>
