...
$stmt=$con->prepare("SELECT distinct month FROM videos WHERE subjectid = ? AND month IS NOT NULL");
$stmt->execute(array($_SESSION['subject']));
$mymonths=$stmt->fetchAll();
...
<head>
    ...
    <title>E-Learning System | Monthly Videos</title>
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <!--            <a class="fw-btn-fill btn-gradient-yellow" href="videoadd.php">Monthly Videos</a>-->
                        <!--        </div>-->
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                      ...
                                      <?php if(!empty($mymonths)){ 
                                          
                                          foreach($mymonths as $mymonth){ ?>
                                                    <tr>
                                        <td><?php echo $mymonth['month'];  ?></td>
                                        <td>
                                            <a class="fw-btn-fill btn-gradient-yellow" href="videostudents.php?m=<?php echo$mymonth['month']; ?>">Students </a>
                                        </td>   
