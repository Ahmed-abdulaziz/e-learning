...
$do = $_GET['do'];
 ...
 if($do == 'delete'){
    if($_GET['id']){
      ...
      $stmt->execute();
      header("Location:ass.php?msg=".urlencode("Done Deleteing Assistant"));
      exit();
...
<head>
    ...
    <title>E-Learning System | Assistant</title>
                        ...
                        <form class="mg-b-20">
                            <div class="row gutters-8">
                                ...
                                <div class="col-1-xxxl col-xl-2 col-lg-3 col-12 form-group">
                                    <a class="fw-btn-fill btn-gradient-yellow" href="addass.php">Add Assistant</a>
                                </div>
                            </div>
                        </form>  
                                ...
                                <tbody>
                                    <tr>
                                      <?php if(isset($_SESSION['adminname'])){ foreach($admins as $admin){ ?>
                                        ...
                                        <td>
                                            <a class="fw-btn-fill btn-gradient-yellow" href="editass.php?do=edit&id=<?php echo $admin["id"] ?>">Edit </a>
                                            <a class="fw-btn-fill btn-gradient-yellow" href="ass.php?do=delete&id=<?php echo $admin["id"] ?>">Delete</a>
                                        </td>
