...
if(empty($err)){
    ...
    // -------------------------------------------------------------------------------------------------------------
            ...
            $stmt=$con->prepare("INSERT INTO questions (question,choice1,choice2,choice3,choice4,answer,subjectid,image,status,lesson,givens,imgchoice1,imgchoice2,imgchoice3,imgchoice4)
            VALUES(:question,:choice1,:choice2,:choice3,:choice4,:answer,:subjectid,:image,:status,:lesson,:givens,:imgchoice1,:imgchoice2,:imgchoice3,:imgchoice4)");
            $stmt->execute(array(
                'question'=>$question ,
                'choice1'=>$choice1,
                'choice2'=>$choice2,
                ...
                'lesson'=>$lessonid ,
                'givens'=>$given , 
                'imgchoice1'=>$imgchoice1 ,
                'imgchoice2'=>$imgchoice2 , 
                'imgchoice3'=>$imgchoice3,
                'imgchoice4'=>$imgchoice4
                ));


    
     if(empty($given)){
            header("Location:multichoice.php?msgg=".urlencode("Done Adding Question"));
            exit();
        }else{
            header("Location:multichoice.php?given_id=$given&msgg=".urlencode("Done Adding Question"));
            exit(); 
        }
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="post" enctype="multipart/form-data">
                                 ...
                                 <input type="text" placeholder="" hidden class="form-control" name="given" value="<?php echo $given_id;?>">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-12 form-group">
                                            ...
                                            <div id="toolbar"></div>
                                            <hr>
                                            <div style="min-height:100px;border:1px solid #333;border-radius: 5px;" class="p-3" id="htmlEditor"  contenteditable="true">Type here...</div>
                                            <input value="" name="editor" id="editor" hidden>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Choice1 *</label>
                                            <div id="toolbar2"></div>
                                            <div class="choices" style="min-height: 40px;background-color:#fff;padding: 5px;border:1px solid #333;border-radius: 5px;" id="htmlEditor2"  contenteditable="true"></div>
                                     ...
                                     <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Choice2 *</label>
                                            <div id="toolbar3"></div>
                                            <div class="choices" style="min-height: 40px;background-color:#fff;padding: 5px;border:1px solid #333;border-radius: 5px;" id="htmlEditor3"  contenteditable="true"></div>
                                            <input value="" name="choice2" id="editor3" hidden>
                                            <!--<input type="text" placeholder="" class="form-control " name="choice2">-->
                                        </div>
                                           <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Choice3 *</label>
                                            <div id="toolbar4"></div>
                                            <div class="choices" style="min-height: 40px;background-color:#fff;padding: 5px;border:1px solid #333;border-radius: 5px;" id="htmlEditor4"  contenteditable="true"></div>
                                            <input value="" name="choice3" id="editor4" hidden>
                                            <!--<input type="text" placeholder="" class="form-control " name="choice3" >-->
                                        </div>
                                           <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Choice4 *</label>
                                            <div id="toolbar5"></div>
                                            <div class="choices" style="min-height: 40px;background-color:#fff;padding: 5px;border:1px solid #333;border-radius: 5px;" id="htmlEditor5"  contenteditable="true"></div>
                                            <input value="" name="choice4" id="editor5" hidden>
                               ...
                               <input type="text" value="<?php echo $s_id;?>" id="s_id" hidden>
                                        ...
                                        <div class="col-12 form-group mg-t-8">
                                            ...
                                            <button type="submit" class="btn-fill-lg bg-blue-dark btn-hover-yellow add" name="add" disabled>Add</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
