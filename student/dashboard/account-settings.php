...
if(empty($err4)){
    ...
    header("Location:index2.php?mssg=".urlencode("Done Editing Admin"));
    exit();
}
}
...
<head>
    ...
    <title>E-Learning System | Edit Admin</title>
                                          ...
                                          <div class="col-xl-3 col-lg-6 col-12 form-group">
                                                <label>Type *</label>
                                                    <select class="form-control"  name="type" >  
                                                     <option <?php if($admins['type'] == 'super admin'){echo "selected";} ?>  value="super admin">Super Admin</option>
                                                     <option <?php if($admins['type'] == 'admin'){echo "selected";} ?> value="admin">Admin</option>
                                                      <option <?php if($admins['type'] == 'assistant'){echo "selected";} ?> value="assistant">Assistant</option>
                                                    </select>              
                                         </div>
