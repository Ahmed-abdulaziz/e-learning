...
if(isset($_POST['add'])){
    ...
    $stmt=$con->prepare("INSERT INTO branches (name , units,Chapter,subjectid)
    VALUES(:name , :units,:Chapter,:subjectid)");
    $stmt->execute(array('name'=>$namee , 'units'=>$unit,'Chapter'=>$chapter ,'subjectid'=>$_SESSION['subject']));
    header("Location:lessons.php?msgg=".urlencode("Done Adding Lesson"));
    exit();


}} else {
    error_log("CSRF Failed from file lessonadd.php", 0);
}
}
...
<head>
    ...
    <title>E-Learning System  | Add lessons</title>
                                ...
                                <form class="new-added-form" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <label>Name</label>
                                            <input type="text" placeholder="New Name" class="form-control" name="namee"  required>
