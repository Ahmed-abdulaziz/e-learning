...
<head>
    ...
    <title>E-Learning System | Teachers</title>
                        ...
                        <form class="mg-b-20">
                            <div class="row gutters-8">
                                ...
                                <div class="col-1-xxxl col-xl-2 col-lg-3 col-12 form-group">
                                    <a class="fw-btn-fill btn-gradient-yellow" href="web_imagesop.php">Add images</a>
                                </div>
                                ...
                                <tbody>
                                    <tr>
                                      <?php foreach($images as $img){ ?>
                                        ...
                                        <td><img style="width: 51px;" src="../../img/course/<?php echo $img['image'];?>"></td>
                                        <td>
                                            <a class="fw-btn-fill btn-gradient-yellow" href="web_imagesop.php?do=delete&id=<?php echo $img['id']; ?>">Delete</a>
                                        </td>
