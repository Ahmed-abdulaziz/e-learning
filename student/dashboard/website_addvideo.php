...
if(empty($error)){
    ...
    if(!empty($_FILES['image']['name'])){
        ...
        $stmt=$con->prepare("INSERT INTO website_videos (link,descryption,img) VALUES(:link,:descryption,:img)");
        $stmt->execute(array('link'=>$link,'descryption'=>$descryption,'img'=>$image));

    }else{
        $stmt=$con->prepare("INSERT INTO website_videos (link,descryption) VALUES(:link,:descryption)");
        $stmt->execute(array('link'=>$link,'descryption'=>$descryption));
    }
        header("Location:website_showvideo.php?mssg=".urlencode("Done Adding Video"));
        exit();
}
}
                              ...
                              <form class="new-added-form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                         <div class="col-xl-6 col-lg-6 col-12 form-group">
                                            <label>URL *</label>
                                            <input type="text" placeholder="" class="form-control" name="link"  required>
                                        </div> 
