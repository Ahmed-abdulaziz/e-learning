...
if(isset($_GET['given_id'])){
    ...
    header("Location:givens.php?msg=".urlencode("Please Select Given"));
    exit();
}
...
if(isset($_POST['edit']))
    ...
    if(!empty($_FILES['image']['name'])){
        ...
        $stmt=$con->prepare("UPDATE  givens SET text=? ,image=? WHERE id=?");     
        $stmt->execute(array($text,$Mimage,$id));

    
    header("Location:givens.php?msgg=".urlencode("Done Edit Given"));
    exit();
                                ...
                                <form class="new-added-form" method="post" enctype="multipart/form-data"> 
                                    <div class="row">
                                       <div class="col-xl-4 col-lg-6 col-12 form-group">
                                            <label>Text</label>
                                            <input type="text" placeholder="" value="<?php echo $given['text'];?>" class="form-control" name="text" >
                                         </div>
                                        <div class="col-xl-4 col-lg-6 col-12 form-group">
                                            <label>Image</label>
