...
$files=$stmt->fetch();
unlink("uploads/files/".$files['file']);
$stmt=$con->prepare("DELETE FROM files WHERE id=? ");
$stmt->execute(array($id));
header("Location:files.php?msg=".urlencode("Done Deleteing file"));
exit();
}}}
                    ...
                    <div class="card-body">
                        ...
                        <form class="mg-b-20">
                            <div class="row gutters-8">
                                ...
                                <div class="col-1-xxxl col-xl-2 col-lg-3 col-12 form-group">
                                    <a class="fw-btn-fill btn-gradient-yellow" href="fileadd.php">Add File</a>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                      <?php if(isset($_SESSION['adminname'])){ foreach($files as $file){ ?>
                                        
                                        <td><?php echo $file['id']  ?></td>
                                        <td><?php echo $file['name']  ?></td>
                                        <td>
                                            <a class="fw-btn-fill btn-gradient-yellow" href="fileedit.php?do=edit&id=<?php echo $file["id"]; ?>">Edit </a>
                                            <a class="fw-btn-fill btn-gradient-yellow" href="files.php?do=delete&id=<?php echo $file["id"] ?>">Delete</a>
                                        </td>
