...
$do = $_GET['do'];
 ...
 if($do == 'delete'){
    if($_GET['id']){
      ...
      $stmt->execute();
      header("Location:teachers.php?msg=".urlencode("Done Deleteing Teacher"));
      exit();
  }}}
                        ...
                        <form class="mg-b-20">
                            <div class="row gutters-8">
                                ...
                                <div class="col-1-xxxl col-xl-2 col-lg-3 col-12 form-group">
                                    <a class="fw-btn-fill btn-gradient-yellow" href="teacheradd.php">Add Teacher</a>
                                </div>
                                ...
                                <tbody>
                                    <tr>
                                      <?php foreach($teachers as $teacher){ ?>
                                        ...
                                        <td>
                                            <a class="fw-btn-fill btn-gradient-yellow" href="teacheredit.php?do=edit&id=<?php echo $teacher["id"] ?>">Edit </a>
                                            <a class="fw-btn-fill btn-gradient-yellow" href="teachers.php?do=delete&id=<?php echo $teacher["id"] ?>">Delete</a>
                                        </td>
