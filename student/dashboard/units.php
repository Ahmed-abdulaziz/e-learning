...
$do = check($_GET['do']);
 ...
 if($do == 'delete'){
    if($_GET['id']){
      ...
      $stmt->execute();
      header("Location:units.php?msg=".urlencode("Done Deleteing Unit"));
      exit();
  }}}
...
<head>
    ...
    <title>E-Learning System  | Units</title>
                        ...
                        <form class="mg-b-20">
                            <div class="row gutters-8">
                                ...
                                <div class="col-1-xxxl col-xl-2 col-lg-3 col-12 form-group">
                                    <a class="fw-btn-fill btn-gradient-yellow" href="units-add.php">Add Units</a>
                                </div>
                                ...
                                <tbody>
                                    <tr>
                                      <?php foreach($branches as $branch){ ?>
                                        ...
                                        <td>
                                            <a class="fw-btn-fill btn-gradient-yellow" href="units-edit.php?do=edit&id=<?php echo $branch["id"] ?>">Edit </a>
                                            <a class="fw-btn-fill btn-gradient-yellow" href="?do=delete&id=<?php echo $branch["id"] ?>">Delete</a>
                                        </td>
