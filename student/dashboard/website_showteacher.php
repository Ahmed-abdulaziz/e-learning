...
$do = $_GET['do'];
 if($do == 'delete'){
    if($_GET['id']){
      ...
      $stmt = $con->prepare("SELECT img  FROM website_teacher WHERE id = ?");
      ...
      $stmt = $con->prepare("DELETE  FROM website_teacher WHERE id = :zid");
      $stmt->bindParam(":zid", $id);
      $stmt->execute();
      header("Location:website_showteacher.php?msg=".urlencode("Done Deleteing Teacher"));
      exit();
 }}}
...
<head>
    ...
    <title>E-Learning System | Teacher</title>
...
<!--msg for edit-->
                         <?php if(isset($_GET['mssg'])){?>
                                ...
                                <a href='website_addteacher.php' class="fw-btn-fill btn-gradient-yellow">Add</a>
                                ...
                                <tbody>
                                    <tr>
                                      <?php  foreach($allsubjects as $allsubject){ ?>
                                        ...
                                        <td><?php echo $allsubject['name']  ?></td>
                                         ...
                                         <td>
                                            ...
                                            <a href="website_editteacher.php?do=edit&id=<?php echo $allsubject["id"] ?>" class="fw-btn-fill btn-gradient-yellow">Edit </a>
                                               <a href="website_showteacher.php?do=delete&id=<?php echo $allsubject["id"] ?>" class="fw-btn-fill btn-gradient-yellow">Delete</a>
