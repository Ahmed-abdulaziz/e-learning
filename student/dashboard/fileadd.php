...
$stmt=$con->prepare("INSERT INTO files (name,file,subjectid) VALUES(:name,:file,:subjectid) ");
$stmt->execute(array('name'=>$fname , 'file'=>$Mimage,'subjectid'=>$subjectid));
header("Location:files.php?msgg=".urlencode("Done Adding File"));
exit();
...
<head>
    ...
    <title>E-Learning System | Add File</title>
                                ...
                                <form class="new-added-form" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-6 col-12 form-group">
                                            <label>Name *</label>
                                            <input type="text" placeholder="Enter Name" class="form-control" name="name"  value="<?php if(!empty($err)){echo $fname;} ?>"required>
                                          
                                        </div>
                                        <div class="col-xl-4 col-lg-6 col-12 form-group">
                                            <label>File</label>
                                            <input type="file" placeholder="Upload File" class="form-control" name="file" required>
