...
if($do=='approveall'){
    ...
    $stmt->execute(array("1",$subjectid,"2"));
    ...
    header("Location:studisaprov.php?msg=".urlencode("Done Approve Students"));
    exit();
}elseif($do=='approve'){
    ...
    header("Location:studisaprov.php?mmssg=".urlencode("Student Approved Successfully"));
      exit();
}
}
...
<head>
    ...
    <title>E-Learning System | Home 1</title>
...
-->
                        ...
                        <a href="studisaprov.php?do=approveall"  class="fw-btn-fill btn-gradient-yellow">Approve All</a>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $admin['phone1']  ?></td>
                                         ...
                                         <td>
                                             ...
                                             <a href="studisaprov.php?do=approve&id=<?php echo $admin["id"] ?>"  class="fw-btn-fill btn-gradient-yellow">Approve</a></div>
                                        </td>
                                    </tr>
                                    <?php }}   ?>
