...
$do = check($_GET['do']);
 ...
 if($do == 'delete'){
    if($_GET['id']){
      ...
      $stmt->execute();
      header("Location:chapters.php?msg=".urlencode("Done Deleteing chapter"));
      exit();
  }}}
...
<head>
    ...
    <title>E-Learning System  | Chapters</title>
                        ...
                        <form class="mg-b-20">
                            <div class="row gutters-8">
                                ...
                                <div class="col-1-xxxl col-xl-2 col-lg-3 col-12 form-group">
                                    <a class="fw-btn-fill btn-gradient-yellow" href="Chapteradd.php">Add Chapters</a>
                                </div>
                                ...
                                <tbody>
                                    <tr>
                                      <?php foreach($branches as $branch){ ?>
                                        ...
                                        <td>
                                            <a class="fw-btn-fill btn-gradient-yellow" href="chapteredit.php?do=edit&id=<?php echo $branch["id"] ?>">Edit </a>
                                            <a class="fw-btn-fill btn-gradient-yellow" href="chapters.php?do=delete&id=<?php echo $branch["id"] ?>">Delete</a>
                                        </td>
