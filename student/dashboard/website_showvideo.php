...
$do = $_GET['do'];
 if($do == 'delete'){
    if($_GET['id']){
      ...
      $stmt = $con->prepare("SELECT img  FROM website_videos WHERE id = ?");
      ...
      $stmt = $con->prepare("DELETE  FROM website_videos WHERE id = :zid");
      $stmt->bindParam(":zid", $id);
      $stmt->execute();
      header("Location:website_showvideo.php?msg=".urlencode("Done Deleteing Video"));
      exit();
 }}}
                        ...
                        <form class="mg-b-20">
                            <div class="row gutters-8">
                                ...
                                <div class="col-1-xxxl col-xl-2 col-lg-3 col-12 form-group">
                                    <a class="fw-btn-fill btn-gradient-yellow" href="website_addvideo.php">Add Video</a>
                                </div>
                                ...
                                <tbody>
                                    <tr>
                                      <?php  foreach($allsubjects as $allsubject){ ?>
                                         ...
                                         <td><?php echo $allsubject['link']  ?></td>
                                         <td><?php echo $allsubject['descryption']  ?></td>

                                         <td>
                                
                                            <!--<a href="website_showvideo.php?do=delete&id=<?php echo $allsubject["id"] ?>" class="fw-btn-fill btn-gradient-yellow">Delete</a>-->
                                            <a href="website_editvideo.php?do=edit&id=<?php echo $allsubject["id"] ?>" class="fw-btn-fill btn-gradient-yellow">Edit </a>
