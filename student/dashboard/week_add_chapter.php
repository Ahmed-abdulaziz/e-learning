...
if(empty($errr)){
    $stmt=$con->prepare("INSERT INTO week_chapters (name,subjectid) VALUES(:name,:subjectid)");
    $stmt->execute(array('name'=>$name,'subjectid'=>$_SESSION['subject']));
    header("Location:week_chapter.php?mssg=".urlencode("Done Add chapter"));
     exit();
}
   

}} else {
    error_log("CSRF Failed from file week_add_chapter.php", 0);
}
}
...
<head>
    ...
    <title>E-Learning System | Add Week Chapter</title>
        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>Add Week Chapter</h3>
                    <ul>
                        <li>
                            <a href="index2.php">Home</a>
                        </li>
                        <li>Add Week Chapter</li>
                    </ul>
                </div>
