 ...
 if($do == 'pass'){
    if($_GET['id']){
        ...
        $exam2 = check($_GET['ex2']);
            ...
            $stmt=$con->prepare("UPDATE  studentexam SET status=?  WHERE id=?");     
            $stmt->execute(array(1, $id));
      
        header("Location:students_fail.php?wid=$wid&ex2=$exam2&msg=".urlencode("Done Pass Student"));
        exit();
  }}
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                      <?php foreach($students_exam as $student){ 
                                      
                                            $stmt=$con->prepare("SELECT name,phone,phone2 FROM students WHERE id = ? ");
                                      ...
                                      ?>
                                        ...
                                        <td><?php echo $details['phone2']  ?></td>
                                        <td><?php echo $student['result']  ?></td>
                                       
                                        <td>
                                      
                                            <a class="fw-btn-fill btn-gradient-yellow " href="?do=pass&id=<?php echo $student["id"] ?>&wid=<?php echo $wid.'&ex2='.$exam2;?>">Pass</a>
                                        </td>
