...
<div class="navbar navbar-expand-md header-menu-one bg-light">
    ...
    font-size: 18px;
">
            <!--    <a href="charge-wallet.php" class="text-dark">-->
                    ...
                    <div class="admin-img">
                        <img src="<?php
                                    if (!empty($levels['image'])) {
                                        echo "img/profile/" . $levels['image'];
                                    } else {
                                        if ($levels['gender'] == "male") {
                                            echo "img/figure/student1.png";
                                        } elseif ($levels['gender'] == "female") {
                                            echo "img/figure/student.png";
